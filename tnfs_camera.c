...
void tnfs_camera_init() {
	...
	//0 - CMODE_INCAR
	g_camera_specs[0].focal_distance.x = -0x6665;
	g_camera_specs[0].focal_distance.y = 0xE666;
	...
	g_camera_specs[1].focal_distance.z = -0x54000;
	...
	//3 - ???
	g_camera_specs[3].focal_distance.x = 0;
	g_camera_specs[3].focal_distance.y = 0x40000;
	g_camera_specs[3].focal_distance.z = -0xFFFFF;
	g_camera_specs[3].back_distance = 0x140000;
	g_camera_specs[3].id3 = 1;
	g_camera_specs[3].next_id = 4;
	g_camera_specs[3].smoothness = 3;
	g_camera_specs[3].transition_delay = 20;
	g_camera_specs[3].min_distance = -1;

	//4 - ???
	g_camera_specs[4].focal_distance.x = 0;
	g_camera_specs[4].focal_distance.y = 0x3CCCC;
	g_camera_specs[4].focal_distance.z = -0x7FFFF;
	g_camera_specs[4].back_distance = 0x50000;
	g_camera_specs[4].id3 = 1;
	g_camera_specs[4].next_id = 5;
	g_camera_specs[4].smoothness = 3;
	g_camera_specs[4].transition_delay = 20;
	g_camera_specs[4].min_distance = -1;
...
void simpleCamera(int car_id) {
	camera.position.x = g_car_array[car_id].position.x;
	camera.position.y = g_car_array[car_id].position.y + 0x60000;
	camera.position.z = g_car_array[car_id].position.z - 0x100000;
	camera.orientation.x = 0;
	camera.orientation.y = 0;
	camera.orientation.z = 0;
	camera.track_slice = camera.track_slice2 = g_car_array[car_id].track_slice;
}
...
void tnfs_camera_update(tnfs_camera *camera) {
	...
	if (camera->id == 0) {
		 ...
		 */
		camera->target_orientation.x = 0x30000; //0;
